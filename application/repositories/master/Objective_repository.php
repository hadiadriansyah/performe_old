...
require_once(APPPATH . 'interface/master/Objective_repository_interface.php');

class Objective_repository implements Objective_repository_interface {
    protected $model;
