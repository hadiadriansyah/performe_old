            ...
            <div class="card-body">
                <form id="formMapping">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Group Unit</label>
                                <div class="col-sm-8 px-2">
                        ...
                        <div class="col-md-6">
                            <button id="btnModalAddGroup" class="btn btn-inverse-success btn-rounded btn-icon" type="button" data-bs-toggle="modal" data-bs-target="#modalGroup" data-mode="modalAddGroup"> <i class="mdi mdi-plus"></i> </button>

                            <button id="btnModalEditGroup" class="btn btn-inverse-warning btn-rounded btn-icon d-none" type="button" data-bs-toggle="modal" data-bs-target="#modalGroup" data-mode="modalEditGroup"> <i class="mdi mdi-file-check"></i> </button>

                            <button id="btnModalDeleteGroup" class="btn btn-inverse-danger btn-rounded btn-icon d-none" type="button"> <i class="mdi mdi-delete"></i> </button>
                        </div>
                    </div>
