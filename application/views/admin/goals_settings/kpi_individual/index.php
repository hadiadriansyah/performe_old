    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body px-0 pt-2 pb-5">
                                <div id="goalsSettingsContainer" class="table-responsive">
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="bg-inverse-primary">
                                                <th>No</th>
                                                <th>Jabatan <sup>(* KPI)</sup></th>
                                                <th>Unit Kerja <sup>(* KPI)</sup></th>
                                                <th>Unit Penempatan <sup>(* KPI)</sup></th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <div id="kpiIndividualContainer" class="row d-none">
                    <div class="col">
                        <div class="card">
                            <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">KPI</h4>
                                <button type="button" class="btn btn-light btn-submit-kpi is-submit-kpi d-none">Submit</button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-end">
                                        <button class="btn btn-gradient-primary btn-modal is-submit-kpi" type="button" data-bs-toggle="modal" data-bs-target="#modalAddKpi" data-mode="modalAddKpi"> Add KPI </button>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div id="kpiUnitContainer"></div>
                                    </div>
                                    <div class="col-8">
                                        <div id="kpiIndividualContainer"></div>
                                    </div>
                                </div>
