        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Data Objective</h4>
                    <button class="btn btn-lg btn-gradient-primary btn-modal" type="button" data-bs-toggle="modal" data-bs-target="#modalObjective" data-mode="modalAddObjective">+ Add </button>
                </div>
                ...
                <div class="modal fade" id="modalObjective" tabindex="-1" role="dialog" aria-labelledby="modalLabelObjective" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalLabelObjective">Add/Edit Objective</h5>
                            ...
                            <div class="modal-body">
                                <form id="formObjective">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="objective" name="objective" placeholder="Objective">
                                            <div class="error-message text-small text-danger mt-1" id="error-objective"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="btnSaveObjective" class="btn btn-gradient-primary">
                ...
                <div class="table-responsive pb-2">
                    <table id="tableObjective" class="table table-hover">
                        <thead>
                            <tr>
