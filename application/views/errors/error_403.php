    ...
    <div class="content-wrapper d-flex align-items-center text-center error-page bg-danger">
        ...
        <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">You are not allowed to access this page.</h3>
            </div>
            </div>
            <div class="row mt-5">
            <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="javascript:history.back()">Back to previous page</a>
            </div>
            </div>
            <div class="row mt-5">
