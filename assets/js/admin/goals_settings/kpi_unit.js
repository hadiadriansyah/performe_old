(function($) {
    ...
    // function updateKpiIdInDataKPI(prevData, currData) {
    //     let updateKpi = null;
    //     let id = prevData.mode == 'add' ? currData.id : prevData.id;

    //     dataKpi.forEach(perspective => {
    //         perspective.objective_detail.forEach(objective => {
    //             objective.kpi_detail.forEach(kpi => {
    //                 if (kpi.id === prevData.id) {
    //                     if (prevData.mode == 'add') {
    //                         kpi.id = currData.id;
    //                     }
    //                     kpi.kpi_id = currData.kpi_id;
    //                     kpi.measurement = currData.measurement;
    //                     kpi.weight = parseFloat(currData.weight);
    //                     kpi.mode = '';
    //                     updateKpi = kpi;
    //                 }
    //             });
    ...
    //     if (prevData.mode == 'add') {
    //         setupValueKpi(updateKpi);
    //         updateKpiIdInView(prevData, currData);
    //     }
    ...
    // function updateKpiIdInView(prevData, currData) {
    //     const elementsToUpdate = [
    //         `#kpiId-${prevData.id}`,
    //         `#measurement-${prevData.id}`,
    //         `#target-${prevData.id}`,
    //         `#actual-${prevData.id}`,
    //         `#counter-${prevData.id}`,
    //         `#targetId-${prevData.id}`,
    //         `#targetMonth-${prevData.id}`,
    //         `#polarization-${prevData.id}`,
    //         `#index-${prevData.id}`,
    //         `#weight-${prevData.id}`,
    //         `#score-${prevData.id}`,
    //         `.btn-save[data-id="${prevData.id}"]`,
    //         `.btn-cancel[data-id="${prevData.id}"]`,
    //         `.btn-edit[data-id="${prevData.id}"]`,
    //         `.btn-delete[data-id="${prevData.id}"]`,
    //         `.btn-modal-target-actual[data-id="${prevData.id}"]`
    //     ];
    ...
    //         if (element.length) {
    //             if (element.attr('id')) {
    //                 const newId = element.attr('id').replace(prevData.id, currData.id);
    //                 element.attr('id', newId);
    //             }
    //             element.attr('data-id', currData.id);
    //         }
    //     });
    // }
